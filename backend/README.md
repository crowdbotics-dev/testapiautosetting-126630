...
## Project Structure
    ...
    ├── testapiautosetting_126630  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126630`
...
2. Clone this repo and `cd testapiautosetting_126630`
